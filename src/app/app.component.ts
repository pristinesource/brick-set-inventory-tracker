...
import { FooterProgressComponent } from './components/footer-progress/footer-progress.component';
...
@Component({
    selector: 'app-root',
    standalone: true,
    imports: [CommonModule, RouterOutlet, RouterLink, RouterLinkActive, LoadingOverlayComponent, FooterProgressComponent],
